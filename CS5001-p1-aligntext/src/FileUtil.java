...
public class FileUtil {
    ...
    /**
     * Attempts to read the text file specified by filename and returns an array
     * of Strings (paragraphs) found in the file.
     * 
     * @param filename
     *            of the file to read
     * @return Returns an array of Strings, each string representing a paragraph
     *         of text from the file. If an exception occurs an array containing
     *         the empty string is returned.
     */
    public static String[] readFile(String filename) {
        try {
            // try to read from the specified file and store paragraphs (lines
            // of text
            // with new-line at end) in list and convert list to array for
            // return
